...
//split, store as array, capatilise(charAt(),toUpperCase(),slice()), then join. 

// const str = 'los angeles';
// const arr = str.split(' '); //splits the string into an array called arr
// for (let i = 0; i < arr.length; i++) { //for each word in arr, do the following. will keep looping as long as i is less than length. Will do what is in {} to each array.
//     arr[i] = arr[i].charAt(0).toUpperCase() + arr[i].slice(1); //takes the first letter(charAt) in eachword and capatilises(toUpperCase) it. arr[i]-the first letter is then added to sliced part of the word(index 1 onwards).

// }
// const str2 = arr.join(" "); //joins them back all together
// console.log(str2);
...
// //a function type that shortens/cuts off text. Eg. used to sumarise a longer sentence/paragraph. 
...
// // // middle of the animals array with newValue //splice method - remove then add
...
// regardless of upper/lower case. //create function, lowercase them .toLowerCase, .filter arrow function .beginsWith then return.

// function findMatchingAnimals(arr, beginsWith) {
//     return arr.filter((el) => el.toLowerCase().includes(beginsWith.toLowerCase()));
// };

// console.log(findMatchingAnimals(animals,'ti'));

// 4. Write a function camelCase(cssProp) that changes dash-separated CSS properties like
// 'margin-left' into camel-cased 'marginLeft'.
// The function should remove all dashes, and uppercase the first letter of each word after a
// dash.
//string.replace() method, Array.map(), Array.join() Methods
// console.log(camelCase('margin-left')) // marginLeft
// console.log(camelCase('background-image')) // backgroundImage
// console.log(camelCase('display')) // display

// let str ='margin-left';
// let camelCased = str.replace(/-([a-z])/g, (match, g) => {
...
//     return inputString.replace(/-([a-z])/g, (match, letter) => {
//         return letter.toUpperCase();
//     });
// }

// let str = '';
// let new = camelCase(str);
...
function currencyOperation(a, b,) {
    const num1 = a;
    const num2 = b;
    ...
    console.log(currencyOperation(1, 1));

// console.log(currencyAddition(0.20, 0.10));
// console.log(currencySubtraction(0.20, 0.10));
// console.log(currencyDivide(0.20, 0.10));
// console.log(currencyMultiply(0.20, 0.10));
...
//object.value to get object values
//.reduce to iterate over arrays
...
// Not correct:
// let topEarner = Object.values(salaries);
// topEarner.sort();
// let topEarner2 = topEarner[topEarner.length - 1]; 
// console.log(topEarner2);
